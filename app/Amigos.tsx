...
const styles = StyleSheet.create({
  ...
  requestsBanner: { backgroundColor: "#fff", marginHorizontal: 20, marginTop: -15, marginBottom: 10, borderRadius: 16, shadowColor: "#000", shadowOpacity: 0.1, shadowOffset: { width: 0, height: 3 }, shadowRadius: 5, elevation: 4 },
  requestsBannerContent: { flexDirection: "row", alignItems: "center", padding: 16 },
  requestsBannerIcon: { width: 48, height: 48, borderRadius: 24, backgroundColor: "#E8F4F8", justifyContent: "center", alignItems: "center", marginRight: 12, position: "relative" },
  ...
  requestsModalContainer: { backgroundColor: "#fff", borderTopLeftRadius: 20, borderTopRightRadius: 20, height: "80%", marginTop: "auto" },
  requestsModalHeader: { flexDirection: "row", justifyContent: "space-between", alignItems: "center", padding: 20, borderBottomWidth: 1, borderBottomColor: "#f0f0f0" },
  requestsModalTitle: { fontSize: 20, fontWeight: "700", color: "#333" },
  requestsList: { flex: 1, padding: 16 },
  requestCard: { flexDirection: "row", alignItems: "center", backgroundColor: "#fff", borderRadius: 16, padding: 16, marginBottom: 12, shadowColor: "#000", shadowOpacity: 0.05, shadowOffset: { width: 0, height: 2 }, shadowRadius: 4, elevation: 2, borderWidth: 1, borderColor: "#f0f0f0" },
